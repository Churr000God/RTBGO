-- 77_tiempo_excepcion_protege_dia_cerrado.sql
...
-- señala"). Encontrado investigando las filas id=9/10 (dia_id=5, ver 76_*.sql sección "Alcance
...
-- fn_dia_revisar (73_*.sql/76_*.sql): cuando arma un tramo nuevo/existente con la marca tardía
...
-- marca -- el propio comentario de fn_dia_revisar (76_*.sql) ya lo documenta explícito ("incluido
...
--   54_tiempo_rls_tramo_lectura.sql, 73_tiempo_fn_dia_revisar_resuelve_excepcion_de_dia.sql,
...
COMMENT ON FUNCTION tiempo.fn_excepcion_protege_dia_cerrado() IS
  ...
  'transacción. SECURITY DEFINER a propósito -- ver cabecera de 77_*.sql.';
