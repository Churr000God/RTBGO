...
-- departamento placeholder por cada una de las 6 áreas (las 5 reales + la nueva), sólo para que
-- esos 6 puestos de dirección tengan dónde colgar sin violar la FK. Decisión de modelado aceptada
-- explícitamente por el usuario — estos 6 departamentos NO son estructura real del organigrama,
-- no confundirlos con los sembrados en 13_departamento_migracion_inicial.sql.
