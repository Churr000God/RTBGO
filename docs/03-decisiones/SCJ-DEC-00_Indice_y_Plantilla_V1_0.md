...
| `SCJ-DEC-06` | ¿El día es entidad materializada con estado propio, o estado derivado de sus marcas? | Propuesta | — |
| `SCJ-DEC-07` | ¿`requiere_revision`/`motivo_revision` como atributos de la marca, o entidad de excepción? | Propuesta | — |
| `SCJ-DEC-08` | ¿`evento_id` es clave primaria de la marca, o alterna junto a una subrogada? | Propuesta | — |
| `SCJ-DEC-09` | ¿Cómo se aplica la unicidad de `terminal_id` + `secuencia_local`, condicional a `origen`? | Propuesta | — |
